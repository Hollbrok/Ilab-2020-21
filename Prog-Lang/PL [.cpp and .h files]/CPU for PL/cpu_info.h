...
void	cmd_push_exe(int command, int i, Stack* stk, struct  Rix* rix_struct, char* OP);
void	cmd_pop_exe(int command, int i, Stack *stk, struct Rix *rix_struct, char *OP);
